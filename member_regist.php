...
// セッションからフォーム値を取得
$last_name    = isset($_POST['last_name']) ? $_POST['last_name'] : (isset($_SESSION['form']['last_name']) ? $_SESSION['form']['last_name'] : '');
$first_name   = isset($_POST['first_name']) ? $_POST['first_name'] : (isset($_SESSION['form']['first_name']) ? $_SESSION['form']['first_name'] : '');
